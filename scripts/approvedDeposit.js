...
const ABI = require("../artifacts/contracts/ship.sol/ship.json");
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("ship");
  const nft = await NFT.attach("0xD6860570982c4193A31D36853765b1CFA1ed205f");
